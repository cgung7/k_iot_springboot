...
public class I_ProductServiceImpl implements I_ProductService {
    ...
    public ResponseDto<ProductResponse.DetailResponse> update(
            Long productId, ProductRequest.@Valid Update req)
    {
        ProductResponse.DetailResponse data = null;
        ...
        boolean nameChange = req.name() != null && !Objects.equals(product.getName(), req.name());
        boolean priceChange = req.price() != null && !Objects.equals(product.getPrice(), req.price());
