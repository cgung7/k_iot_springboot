...
public interface G_AdminService {
    ...
    ResponseDto<RoleManageResponse.AddRolesResponse> addRoles(UserPrincipal principal, RoleManageRequest.@Valid AddRoleRequest req);

    ResponseDto<RoleManageResponse.RemoveRolesResponse> removeRoles(UserPrincipal principal, RoleManageRequest.@Valid RemoveRoleRequest req);
}
