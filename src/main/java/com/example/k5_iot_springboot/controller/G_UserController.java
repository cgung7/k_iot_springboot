...
public class G_UserController {
    ...
    @GetMapping
    public ResponseEntity<ResponseDto<UserProfileResponse.MyRageResponse>> getMyInfo(
            @AuthenticationPrincipal UserPrincipal principal

    ) {
        ResponseDto<UserProfileResponse.MyRageResponse> response = userService.getMyInfo(principal);
    ...
    @PreAuthorize("isAuthenticated()")
    @PutMapping
    public ResponseEntity<ResponseDto<UserProfileResponse.MyRageResponse>> updateMyInfo(
            @AuthenticationPrincipal UserPrincipal principal,
            @Valid @RequestBody UserProfileUpdateRequest request
            ){
        ResponseDto<UserProfileResponse.MyRageResponse> response = userService.updatedMyInfo(principal, request);
        return ResponseEntity.ok().body(response);
