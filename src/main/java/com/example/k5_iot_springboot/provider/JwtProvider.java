...
public class JwtProvider {
    ...
    public JwtProvider(
        ...
        this.clockSkewSeconds = Math.max(clockSkewSeconds, 0); // 최소 0
...
//                .signWith(key, SignatureAlgorithm.HS256)
    ...
    // 토큰 유효성 검사 (서명/만료 포함) / clock - skew 허용 작성
    ...
    // roles >> Set<String> 변환
    @SuppressWarnings("unckecked") // 제네릭 캐스팅 경고 억제 (런타임 확인으로 보완)
